      ...
      <div style={wm}>
        ...
        <div
          ...
          style={{
            marginTop: 12,
            height: 1,
            background: "rgba(196,166,255,0.4)",
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          inset: 0,
          background:
            "radial-gradient(circle at 70% 25%, rgba(192,132,252,0.35), transparent 60%)",
          opacity: 0.7,
        }}
      />
      <div style={wm}>
        ...
        <div
          ...
          style={{
            ...
            color: "transparent",
            WebkitTextStroke: "1px var(--violet-300)",
          }}
        >
          CHAIN
        </div>
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          height: "34%",
          background:
            "linear-gradient(180deg, rgba(233,213,255,0.12), transparent)",
      ...
      <div style={{ ...wm, bottom: 48 }}>
        ...
        <div
          ...
          style={{
            ...
            color: "transparent",
            WebkitTextStroke: "1.2px var(--violet-100)",
          }}
        >
          LOOM
        </div>
...
const shelvefyMotion = (root, raised, ms) => {
  ...
  if (raised) {
    ...
    bars.forEach((bar, i) =>
      utils.set(bar, { translateX: i % 2 ? 260 : -260, opacity: 0 }),
    );
    animate(bars, {
      translateX: 0,
      opacity: 1,
    ...
    >
      <div
        ...
        style={{
          ...
          top: "22%",
          height: 6,
          background: "linear-gradient(90deg,#8b5cf6,#e9d5ff)",
        }}
      />
      <div
        data-art="bar"
    ...
    >
      <div
        ...
        style={{
          ...
          inset: 0,
          background:
            "repeating-radial-gradient(circle at 50% 50%, rgba(168,85,247,0.30) 0 1px, transparent 1px 17px)",
          opacity: 0.8,
        }}
      />
      <div
        ...
        style={{
          ...
          inset: 0,
          background:
            "radial-gradient(circle at 50% 50%, rgba(216,180,254,0.28), transparent 55%)",
          opacity: 0.75,
        }}
      />
      <div
